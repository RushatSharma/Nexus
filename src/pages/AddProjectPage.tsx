                        ...
                        <div className="grid gap-6 md:col-span-2">
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>Fill in the main details of the case study.</CardDescription>
                                </CardHeader>
                                <CardContent className="grid gap-6">
                                    <div className="grid gap-3">
                                        <Label htmlFor="title">Project Title</Label>
                                        <Input id="title" type="text" placeholder="e.g., Complete Digital Overhaul" />
                                    </div>
                                    <div className="grid gap-3">
                                        <Label htmlFor="client">Client Name</Label>
                                        <Input id="client" type="text" placeholder="e.g., UrbanBloom" />
                                    </div>
                                    <div className="grid gap-3">
                                        <Label htmlFor="description">Short Description</Label>
                                        <Textarea id="description" placeholder="A brief summary that will appear on the projects page." />
                                    </div>
                                    <div className="grid gap-3">
                                        <Label htmlFor="challenge">The Challenge</Label>
                                        <Textarea id="challenge" placeholder="Describe the client's problem or main challenge." />
                                    </div>
                                </CardContent>
                            </Card>
                        </div>
                        ...
                        <div className="grid gap-6 md:col-span-1">
                            <Card>
                                ...
                                <CardContent className="grid gap-6">
                                    ...
                                    <div className="grid gap-3">
                                        ...
                                        <Input id="services" type="text" placeholder="e.g., SEO, PPC, Social Media" />
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>Upload the main image for the project.</CardDescription>
                                </CardHeader>
                                <CardContent>
                             ...
                             <Button size="lg" className="w-full btn-primary">Save Project</Button>
                        </div>
                    </form>
                </div>
            </main>
